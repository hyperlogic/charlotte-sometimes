...
EntityCharlotte = ig.Entity.extend({
    ...
    init: function (x, y, settings) {
        ...
        this.addAnim('move', 0.1, [9,10,11,12]);
        this.addAnim('grabIdle', 0.2, [16]);
        this.addAnim('grabMove', 0.2, [17,18,19,20]);
        this.addAnim('useFail', 0.1, [24,25,26]);
        this.addAnim('use', 0.2, [16]);
        ...
        this.sm.addState({
            name: 'useFail',
            enter: function () {
                this.useFailTimer = new ig.Timer(0.3);
                var prevAnim = this.currentAnim;
